...
function createLi(data){
	...
	li+='</li>';
	li+='<li><hr></li>';
	li+='<li><img src="images/doc.png">&nbsp;<a href="http://localhost:9000/file/'+data.docTitle+'">'+data.docTitle+'</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;';
	...
	li+='&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;';
	li+='<a href="http://localhost:9000/file/'+data.docTitle+'"><img src="images/dowload.png" title="下载"></a>';
	li+='</li>';
	var $li=$(li);
	$('.ulList').append($li);
}